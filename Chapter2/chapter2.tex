...
Kinematic factor of the HNL production from meson decays as compared to the analogous SM neutrino production.
}
...
Upper limits on the mixing $|U_{\mu4}|^{2}$ at 90\% confidence level for Majoranan HNLs in the mass range of $0 < m_{N} < 265$ MeV.
}
