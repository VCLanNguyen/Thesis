...
%********************************** %First Section  **************************************
\section{Overview of Liquid Argon Time Projection Chambers}
\label{sec3:overview}
%1: Introduction
...
In addition to Rayleigh scattering, scintillation photons also undergo absorption, which arises due to contaminants in liquid argon.
...
%The signals induced or collected on the wire planes are then shaped, amplified, and digitised by cold electronics submerged in liquid argon to minimise noise.
