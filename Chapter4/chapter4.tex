...
%However, reflected visible photons have a faster group velocity (See Fig. \ref{fig:vuv_visible} Sec. \ref{sec:photonprop}) and arrive at detection earlier than some direct VUV photons.
