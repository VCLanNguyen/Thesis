...
% SPEC TDC 
Following Fig. \ref{}, one application of the SPEC-TDC is to synchronise the DAQ system with respect to the beam.
...
%T1 Clock 
%Furthermore, these timestamps can also be used to evaluate the timing resolution of the CRT electronics, which use the BES signals for internal clock resets.
